...
class WaitMode(Enum):
    ...
    PROGRESSION = (
        "progression"  # Wait for SequenceView/LoopView completion  # Wait for agent to complete
    )
...
class Projection:
    ...
    def render(self) -> str:
        ...
        for section in self.sections:
            if section.content:
                prefix = "  " * section.indent
                # Indent each line of multiline content
                indented = "\n".join(prefix + line for line in section.content.split("\n"))
