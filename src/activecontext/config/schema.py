...
PACKAGE_DEFAULT_STARTUP: list[str] = [
    'markdown("@prompts/dsl_reference.md", tokens=2000, expansion=Expansion.DETAILS)',
    'markdown("@prompts/node_states.md", tokens=500, expansion=Expansion.DETAILS)',
    'markdown("@prompts/context_graph.md", tokens=500, expansion=Expansion.DETAILS)',
    'markdown("@prompts/work_coordination.md", tokens=500, expansion=Expansion.DETAILS)',
    'markdown("@prompts/mcp.md", tokens=500, expansion=Expansion.DETAILS)',
]
